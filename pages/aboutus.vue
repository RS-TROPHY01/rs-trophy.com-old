...
const title = "RS TROPHY | เกี่ยวกับเรา";
const description =
...
useSeoMeta({
  ...
  ogImage: image,
  twitterImage: image,
  keywords: "RS TROPHY, เกี่ยวกับเรา",
});
</script>
<template>
  <div>
    ...
    <div class="w-full px-6 mb-10 lg:mb-0">
      <div class="pl-4 mb-6 border-l-4 border-blue-500">
        ...
        <h2 class="mt-2 text-3xl font-black md:text-5xl">RS TROPHY</h2>
      </div>
      <p class="mb-6 text-base leading-7">
        RS TROPHY
        เป็นบริษัทจัดจำหน่วยโล่รางวัลชั้นนำในประเทศด้วยราคาโรงงานโดยจัดจำหน่ายถ้วยรางวัล
